...
public class MainAlatMusikSaron extends AppCompatActivity {
    ImageButton play;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alat_musik_saron);
        ...
        mediaPlayer=MediaPlayer.create(MainAlatMusikSaron.this,R.raw.saron);
