...
public class MainAlatMusikBonang extends AppCompatActivity {
    ImageButton play;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alat_musik_bonang);
        ...
        mediaPlayer=MediaPlayer.create(MainAlatMusikBonang.this,R.raw.bonang);
