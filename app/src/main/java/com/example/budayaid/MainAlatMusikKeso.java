...
public class MainAlatMusikKeso extends AppCompatActivity {
    ImageButton play;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_alatmusikkeso);
        ...
        mediaPlayer= MediaPlayer.create(MainAlatMusikKeso.this,R.raw.kesokeso);
